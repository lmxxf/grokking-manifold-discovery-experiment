"""
Grokking 实验四：秩约束对 Grokking 的影响（模乘法版本）
在中间层添加低秩瓶颈，测试不同瓶颈维度对 Grokking 时间的影响

用法（在 Docker 容器内）：
    python /workspace/ai-theorys-study/arxiv/wechat67/exp_group2_multiplication/code/train_bottleneck.py
"""
...
def main():
    ...
    parser.add_argument("--output_dir", type=str,
                        default="/workspace/ai-theorys-study/arxiv/wechat67/exp_group2_multiplication/results/exp4_bottleneck",
                        help="输出目录")
    ...
    print(f"Operation: modular multiplication")
    ...
    # 打印汇总表格
    print("\n" + "="*70)
    print("SUMMARY: Bottleneck Dimension vs Grokking Time (Multiplication)")
    print("="*70)
