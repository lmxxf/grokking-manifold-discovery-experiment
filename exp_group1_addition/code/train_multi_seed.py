...
用法（在 Docker 容器内）：
    python /workspace/ai-theorys-study/arxiv/wechat67/exp_group1_addition/code/train_multi_seed.py
...
OUTPUT_BASE = "/workspace/ai-theorys-study/arxiv/wechat67/exp_group1_addition/results_multi_seed"
    ...
    summary = {
        ...
        "statistics": {
            "first_grok_step": {
                ...
                "mean": np.mean([r["first_grok_step"] for r in results if r["first_grok_step"]]),
                "std": np.std([r["first_grok_step"] for r in results if r["first_grok_step"]]),
            },
            "oscillation_count": {
