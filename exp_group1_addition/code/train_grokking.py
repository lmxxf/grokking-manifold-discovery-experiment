"""
Grokking 实验一：内在维度突变
复现 Power et al. 2022 的模加法 Grokking，并记录中间层激活用于维度分析

用法（在 Docker 容器内）：
    python /workspace/ai-theorys-study/arxiv/wechat67/train_grokking.py
"""
...
CONFIG = {
    ...
    "seed": 42,
    "output_dir": "/workspace/ai-theorys-study/arxiv/wechat67/results",
}
